...
const logos = [
  { src: "/logos/amulette.png",      alt: "Amulette London" },
  { src: "/logos/london.png",        alt: "The London Experience Card" },
  { src: "/logos/london-city.png",   alt: "London City Skin Clinic" },
  { src: "/logos/shelikes.png",      alt: "Shelikes" },
  { src: "/logos/stylewise.png",     alt: "Stylewise Direct" },
  { src: "/logos/personal.png",      alt: "Personal Retirement Planning" },
  { src: "/logos/kiddiwinks.png",    alt: "Kiddiwinks" },
  { src: "/logos/city-therapy.png",  alt: "City Therapy" },
  { src: "/logos/central23.png",     alt: "Central23" },
  { src: "/logos/vivichi.png",       alt: "Vivichi" },
  { src: "/logos/tavistock.png",     alt: "Tavistock Tutors" },
  { src: "/logos/sapnay.png",         alt: "Sapnay" },
  { src: "/logos/ideal-mats.svg",     alt: "Ideal Mats" },
  { src: "/logos/specialist-mats.png", alt: "Specialist Mats" },
];
    ...
    <div className="flex items-end gap-[3px] h-10 mt-3">
      {BAR_HEIGHTS.map((h, i) => (
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ delay: 0.05 * i + 0.2, duration: 0.45, ease: "easeOut" }}
          style={{
            height: `${h}%`,
            transformOrigin: "bottom",
            background: i === BAR_HEIGHTS.length - 1
              ? "#7C3AED"
              : `rgba(124,58,237,${0.15 + i * 0.08})`,
          }}
        />
      ))}
    </div>
    ...
    <section className="border-y border-white/5 bg-background overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-14 pb-10">
        ...
        >
          ...
          <p className="mt-3 text-sm" style={{ color: "rgba(220,200,255,0.45)" }}>
        ...
        <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4 max-w-3xl mx-auto">
          ...
          <motion.div
            ...
            style={{ ...cardBase, backdropFilter: "blur(16px)" }}
          >
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-xs font-semibold" style={{ color: "#4ade80" }}>↑ +8 this month</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-4xl font-black leading-none mb-1" style={{ color: "#7C3AED" }}>
      ...
      <div className="pt-8 pb-14">
        <motion.p
          ...
          className="text-center text-muted-foreground mb-8 uppercase tracking-widest font-semibold text-[16px]"
        >
          Trusted by UK Companies
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          ...
          <div className="flex animate-[marquee_36s_linear_infinite]">
            {[1, 2].map((set) => (
              <div key={set} className="flex flex-shrink-0 items-center">
                {logos.map((logo, i) => (
                  <div key={`s${set}-${i}`} className="flex items-center justify-center px-10 flex-shrink-0">
                    <img
                      src={logo.src}
                      alt={logo.alt}
                      loading="lazy"
                      ...
                      style={{ filter: "brightness(0) invert(1)", opacity: 1, maxWidth: 220 }}
                      draggable={false}
                    />
                  </div>
                ))}
