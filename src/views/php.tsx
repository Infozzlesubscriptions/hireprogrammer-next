...
import {
  ...
  Star, Globe, Wrench, Puzzle, Server, LayoutDashboard, Lock,
} from "lucide-react";
...
const services = [
  {
    ...
    body: "Our PHP engineers are expert in developing a highly responsive, visually appealing, and user-friendly PHP framework websites that first gives the desired result to their customers. We build scalable, SEO-friendly, and high-performance PHP websites tailored precisely to your business objectives.",
    bullets: ["Custom PHP sites", "MVC frameworks", "Performance optimised", "SEO-ready builds"],
  },
  {
    icon: LayoutDashboard,
    title: "Intranet Solutions",
    body: "Whether it's a knowledge management system on your company intranet or digital archives, our team of PHP developers and engineers address all the nitty-gritty of your network to provide you smooth workflow automation and other development services.",
    bullets: ["Internal portals", "Knowledge bases", "Workflow automation", "Document management"],
  },
  {
    icon: Server,
    title: "PHP CMS Development",
    body: "We can build you a bespoke PHP framework CMS development that completely softens your business requirements. Our custom CMS solutions give you full control over your content without relying on off-the-shelf platforms — delivering exactly the features you need and nothing you don't.",
    bullets: ["Custom CMS builds", "Content workflows", "Multi-user roles", "Media libraries"],
  },
  {
    icon: Code2,
    title: "Web Application Development",
    body: "We have experts in developing cross-platform responsive PHP framework web application that gives a professional appealing look and feel to your application. From SaaS platforms to enterprise systems and customer-facing portals, we build PHP applications that are fast, secure, and built to scale.",
    bullets: ["SaaS applications", "Enterprise platforms", "API-driven apps", "Cross-platform"],
  },
  {
    icon: Puzzle,
    title: "Custom API Development",
    body: "Our custom API development support lets your PHP website connect easily with the third parties of your choice. We design and build RESTful and GraphQL APIs that integrate seamlessly with your existing systems, third-party services, and mobile applications.",
    bullets: ["RESTful APIs", "GraphQL", "API documentation", "Third-party sync"],
  },
  {
    icon: Wrench,
    title: "Third-party API Integration",
    body: "Whether you need to integrate social media, Google maps, or payment gateways, HireProgrammer's team of PHP engineers provides a hassle-free third-party API integration. We handle the complete integration lifecycle from selection and configuration through to testing and ongoing maintenance.",
    bullets: ["Payment gateways", "Social media APIs", "Maps & geolocation", "CRM & ERP"],
  },
];

const whyPhp = [
  { title: "Tried And Free Authentication", body: "The easy and simple PHP framework lets you smoothly implement authentication while developing feature-rich complete websites." },
  { title: "Fresh and Auto-running", body: "PHP allows seamless integration with Hatch and AJAX in order to develop dynamic and fully functional websites." },
  { title: "Cost Efficiency", body: "Compared to other web platforms, PHP is cost-effective since it doesn't require a lot of investment during development and maintenance phases." },
  { title: "Compatibility", body: "Being platform-independent, PHP can be successfully run on the majority of used operating systems such as Windows/Linux and Mac." },
];

const whyUsLeft = [
  "A skillset team of PHP designers and developers",
  "Reporting/maintenance and quality assurance",
  "A Customised PHP development solutions",
  "Innovative, customer centric, and result-orientated PHP solutions",
];

const whyUsRight = [
  "Dedicated PHP web development agency in the UK",
  "Excellent customer support",
  "Custom PHP solutions at competitive rates",
];

const faqs = [
  {
    q: "What is PHP and why should I choose it for my website?",
    a: "PHP is a free, open-source server-side scripting language that powers over 75% of the web, including platforms like WordPress, Facebook, and Wikipedia. It's versatile, fast to develop with, has a massive ecosystem of frameworks, and runs on virtually any hosting environment — making it an extremely cost-effective and reliable choice.",
  },
  {
    q: "How much does PHP website development cost in the UK?",
    a: "Costs vary depending on complexity, design, and functionality. Simple brochure websites start from a few thousand pounds, while complex web applications can run considerably higher. We provide transparent, no-obligation quotes tailored to your specific requirements.",
  },
  {
    q: "What types of websites and applications can be built with PHP?",
    a: "PHP is suitable for almost any web project — from simple business websites and landing pages to complex e-commerce stores, SaaS platforms, CMS systems, membership portals, REST APIs, enterprise applications, and real-time dashboards.",
  },
  {
    q: "Can PHP integrate with other technologies and third-party services?",
    a: "Yes. PHP integrates seamlessly with databases (MySQL, PostgreSQL, Redis), front-end frameworks (React, Vue), payment gateways (Stripe, PayPal), CRM systems, social media platforms, mapping services, and virtually any third-party API.",
  },
  {
    q: "Is PHP suitable for building large-scale business applications?",
    a: "Absolutely. PHP powers some of the world's largest and most trafficked websites. With modern frameworks like Laravel and Symfony, PHP applications can be built to enterprise standards with full test coverage, clean architecture, and horizontal scalability.",
  },
  {
    q: "How long does it take to develop a PHP website?",
    a: "A standard PHP website typically takes 3–8 weeks depending on scope, design complexity, and integrations. Larger web applications may take 3–6 months. We agree clear milestones upfront and provide regular progress updates throughout.",
  },
  {
    q: "Do you provide maintenance and support for PHP websites?",
    a: "Yes. We offer flexible ongoing support and maintenance packages covering security updates, PHP version upgrades, performance monitoring, bug fixes, content management, and priority technical support after your project launches.",
  },
];
    ...
    <main className="min-h-screen bg-[#080316] text-foreground overflow-x-hidden selection:bg-primary/30">
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden pt-24">
        <motion.div className="absolute inset-0 z-0" style={{ y: heroY }}>
          <img src="/php-hero-banner.png" alt="PHP Development Services" title="PHP Development Services" className="absolute inset-0 w-full h-full object-cover" style={{ filter: "brightness(0.45) saturate(1.1)" }} />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-14 items-center">
          <motion.div style={{ opacity: heroOp }}>
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs text-primary font-semibold uppercase tracking-widest mb-6" style={pillStyle}>
              <Code2 className="w-3 h-3" /> PHP Web Development Services
            </motion.div>
            <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.65 }} className="text-4xl md:text-6xl font-black text-white leading-[1.08] tracking-tight mb-6">
              Expert{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF40C8] via-[#7C3AED] to-[#C060FF]">PHP Development Company UK</span>
            ...
            <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="text-white/50 text-xl leading-relaxed mb-10 max-w-md">
              Build the right product from the very start — with UK's leading PHP web development agency.
            </motion.p>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25, duration: 0.7 }} className="rounded-2xl p-8" style={{ background: "rgba(6,2,16,0.7)", border: "1px solid rgba(255,255,255,0.08)", backdropFilter: "blur(20px)" }}>
            ...
            <HeroContactForm pageName="PHP Development" extraField={{ label: "Requirement", type: "text", placeholder: "Describe your project..." }} />
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs text-primary font-semibold uppercase tracking-widest mb-5" style={pillStyle}>
                <Code2 className="w-3 h-3" /> PHP Website Development
              </motion.div>
              <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }} className="text-3xl md:text-4xl font-bold text-white leading-tight mb-6">
                UK's Premier{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF40C8] via-[#7C3AED] to-[#C060FF]">PHP Agency</span>
              </motion.h2>
              {[
                "Being a free and open source platform, PHP allows users to design visually rich and user-friendly web services. You can use server-side scripting language can be used to create dynamic web applications and pages. HireProgrammer helps clients fully leverage the benefits of PHP web developers to create highly desired and flexible PHP web applications. Our mission is to deliver best and most qualified, and result-driven team of designers, programmers before achieving accurate PHP web applications.",
                "From simple PHP websites to complex enterprise platforms, HireProgrammer connects you with expert UK-based PHP developers who deliver quality on time and on budget. Our team has deep expertise across all major PHP frameworks including Laravel, Symfony, CodeIgniter, and Zend.",
              ].map((p, i) => (
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }} className="relative">
              <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.07)" }}>
                <img src="https://images.unsplash.com/photo-1542831371-29b0f74f9713?w=900&q=80" alt="PHP development" className="w-full h-80 object-cover" style={{ filter: "brightness(0.70) saturate(0.85)" }} />
              ...
              <div className="absolute -bottom-6 -left-6 px-5 py-4 rounded-xl" style={{ background: "rgba(6,2,16,0.92)", border: "1px solid rgba(124,58,237,0.3)", backdropFilter: "blur(10px)" }}>
                ...
                <div className="text-white/50 text-xs font-semibold uppercase tracking-wider mt-0.5">PHP Projects Delivered</div>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs text-primary font-semibold uppercase tracking-widest mb-5" style={pillStyle}>
                <Star className="w-3 h-3" /> Why PHP?
              </motion.div>
              <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }} className="text-3xl md:text-4xl font-bold text-white leading-tight mb-8">
                Why Makes PHP{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF40C8] via-[#7C3AED] to-[#C060FF]">Development Ideal for Your Brand?</span>
              </motion.h2>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }} className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.07)" }}>
                <img src="https://images.unsplash.com/photo-1550439062-609e1531270e?w=900&q=80" alt="Why PHP" className="w-full h-[440px] object-cover" style={{ filter: "brightness(0.65) saturate(0.8)" }} />
              ...
              <div className="absolute -bottom-6 -right-6 px-5 py-4 rounded-xl" style={{ background: "rgba(6,2,16,0.92)", border: "1px solid rgba(124,58,237,0.25)", backdropFilter: "blur(10px)" }}>
                ...
                <div className="text-white/50 text-xs font-semibold uppercase tracking-wider mt-0.5">Years of PHP Expertise</div>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }} className="relative">
              <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.07)" }}>
                <img src="https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=900&q=80" alt="From ideas to live" className="w-full h-96 object-cover" style={{ filter: "brightness(0.65) saturate(0.85)" }} />
            ...
            <div>
              ...
              <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }} className="text-3xl md:text-4xl font-bold text-white leading-tight mb-6">
                From Ideas to a{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF40C8] via-[#7C3AED] to-[#C060FF]">Live PHP Application</span>
              </motion.h2>
              {[
                ...
                "From discovery through to deployment, our PHP specialists manage every phase transparently, acting as a true extension of your team to deliver results on time and on budget.",
              ].map((p, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          <div className="mb-14">
            ...
            <motion.p initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.14 }} className="text-white/40 text-sm max-w-2xl leading-relaxed">
              Partnering with HireProgrammer gives you access to the top PHP web developers of one of the most preferred PHP development agencies in the UK. We offer complete web development services that perfectly match their business requirements.
            </motion.p>
          </div>
